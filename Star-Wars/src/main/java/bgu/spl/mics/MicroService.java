...
public abstract class MicroService implements Runnable {
    private HashMap< Class ,Callback > HashMapEventToCB;//Hash Map of Events the holds the CallBack Method to any event
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        HashMapEventToCB.putIfAbsent(type,callback);
    ...
    public final void run() {
        ...
        while (!terminated){
            ...
            if (msg != null) {
                try {
                    HashMapEventToCB.get(msg.getClass()).call(msg);//Calls to the right CallBack function
                } catch (InterruptedException e) {
                    e.printStackTrace();
                }
            }
